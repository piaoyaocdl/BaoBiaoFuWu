 ...
 */
public class SysUserHome
{

	private static final Log log = LogFactory.getLog(SysUserHome.class);
	...
	public SysUser merge(SysUser detachedInstance)
	{
		...
		try
		{
			SysUser result = (SysUser) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public SysUser findById(int id)
	{
		...
		try
		{
			SysUser instance = (SysUser) sessionFactory.getCurrentSession().get("deefw.SysUser", id);
			if (instance == null)
			{
	...
	public List<SysUser> findByExample(SysUser instance)
	{
		...
		try
		{
			List<SysUser> results = (List<SysUser>) sessionFactory.getCurrentSession().createCriteria("deefw.SysUser")
