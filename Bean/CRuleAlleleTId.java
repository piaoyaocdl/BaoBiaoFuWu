...
/**
 * CRuleAlleleTId generated by hbm2java
 */
public class CRuleAlleleTId implements java.io.Serializable
{
	...
	public CRuleAlleleTId()
	{
	}

	public CRuleAlleleTId(int id, String useFlag)
	{
		this.id = id;
		this.useFlag = useFlag;
	}

	public CRuleAlleleTId(int id, String ruleName, String useFlag, String ruleType, String recordName, Date recordTime,
			String remark)
	{
		this.id = id;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof CRuleAlleleTId))
			return false;
		CRuleAlleleTId castOther = (CRuleAlleleTId) other;
