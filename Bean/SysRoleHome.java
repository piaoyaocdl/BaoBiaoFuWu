...
/**
 * Home object for domain model class SysRole.
 * @see deefw.SysRole
 * @author Hibernate Tools
 */
public class SysRoleHome
{

	private static final Log log = LogFactory.getLog(SysRoleHome.class);
	...
	{
		log.debug("persisting SysRole instance");
		try
		{
	...
	public SysRole merge(SysRole detachedInstance)
	{
		...
		try
		{
			SysRole result = (SysRole) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public SysRole findById(int id)
	{
		...
		try
		{
			SysRole instance = (SysRole) sessionFactory.getCurrentSession().get("deefw.SysRole", id);
			if (instance == null)
			{
	...
	public List<SysRole> findByExample(SysRole instance)
	{
		...
		try
		{
			List<SysRole> results = (List<SysRole>) sessionFactory.getCurrentSession().createCriteria("deefw.SysRole")
